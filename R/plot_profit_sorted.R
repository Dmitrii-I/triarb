#' Bar plot of arbitrage profit for each tick, sorted
#' 
...
#' @export
#'
plot_profit_sorted <- function(x, separate_plots=FALSE, ...) {
    ...
    # convenience function to print a single plot
        ...
        barplot(sort(x[x[, col] > 0, col], decr=T), main=title, las=1, type='h', xlab='', ylab='', ...)
